...
paste0("QC check 1: ", length(metabolite_list_filtered), " features had < 50 % zero values QC check.  ", length(failed_metabolites_zero), " features had > 50% zero values.")
paste0("QC check 2: ", length(metabolite_list_filtered_2), " features had an % RSD of < 30% in replicate QC samples.  ", length(failed_metabolites_rsd), " features had an RSD > 30% in the PQC.")
...
```{r, CORRECTED mrms_exploreR signal QC check,  eval = FALSE, echo = FALSE, results = FALSE, warning=FALSE, message=FALSE}
...
lgw_pca(FUNC_individual_multivariate_data = mrms_exploreR_data$corrected_data_tic_filtered_qc_filtered,
        FUNC_metabolite_list = feature,
        FUNC_colour_by = "type",
        FUNC_plot_label = "sampleID",
        FUNC_scaling = "Pareto")
