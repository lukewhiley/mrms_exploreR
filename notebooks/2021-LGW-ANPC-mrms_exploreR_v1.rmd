...
This notebook is designed to explore the MRMS dataset and QC check it. The script generates a report and a final dataset that can be used for data modeling.
...
parent_github_function_url <- "https://raw.githubusercontent.com/lukewhiley/targeted_lipid_exploreR_v2/main"

# load custom functions from github

#PCA function
lipidomics_PCA_QC_function <- GET(url = paste0(parent_github_function_url, "/functions/2021-LGW-lipidomics-PCA_QC_checkR_function_v2.r")) %>% 
                                    content(as = "text")
...
```{r, mrms_exploreR read in data,  eval = FALSE, echo = FALSE, results = FALSE, warning=FALSE, message=FALSE}

# download and parse data preparation script
mrms_exploreR_script <- GET(url = paste0(parent_github_url, "/scripts/2021-LGW-mrmsd_exploreR_script.R")) %>% 
                               content(as = "text")
...
```{r, mrms_exploreR QC check 1,  eval = FALSE, echo = FALSE, results = FALSE, warning=FALSE, message=FALSE}
