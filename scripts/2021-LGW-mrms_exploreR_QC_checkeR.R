...
dlg_message(paste0("QC check 1: ", 
                   nrow(percentage_of_zero_plot_data_pass), 
                   " passed QC check and had < 50% zero values.  ", 
                   nrow(percentage_of_zero_plot_data_fail), 
                   " failed QC check and had > 50% zero values.",
                   " ********************************************************** ",
                   "QC check 2: ", 
                   nrow(rsd_plot_data_pass), " features had an % RSD of < 30% in replicate QC samples.  ", nrow(rsd_plot_data_fail), " features had an RSD > 30% in the PQC."))
